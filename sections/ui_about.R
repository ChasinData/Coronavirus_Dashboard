body_about <- dashboardBody(
  fluidRow(
    fluidRow(
      column(
        box(
          title = div("TRASK | About this project", style = "padding-left: 20px", class = "h2"),
          column(
            ...
            please send me an ", tags$a(href = "mailto:sxt@stevetrask.com",
            ...
            tags$a(href = "https://www.stevetrask.com/ch/en/", "My Blog"), "|",
            tags$a(href = "https://www.linkedin.com/in/stephentrask/", "LinkedIn"), "|",
            tags$a(href = "https://twitter.com/traskinsight", "Twitter"), "|",
            tags$a(href = "https://github.com/ChasinData", "Github"),
            width = 12,
